...
@UI: {
 headerInfo: { typeName: 'Travel', typeNamePlural: 'DKS+ Travels', title: { type: #STANDARD, value: 'TravelID' } } }

@Search.searchable: true

define root view entity ZC_TRAVEL_M_DKS
  as projection on ZI_TRAVEL_M_DKS
{
      @UI.facet: [ { id:              'Travel',
                     purpose:         #STANDARD,
