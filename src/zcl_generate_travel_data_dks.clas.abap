CLASS zcl_generate_travel_data_dks DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_dks IMPLEMENTATION.

 METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_dks.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_dks.

*   insert the new table entries
    INSERT ztravel_dks FROM TABLE @itab.
